...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	public void mouseMoved(MouseEvent e) {
		...
		int backgroundColor = -15128848;
		//8. If the mouse falls off the path (if it is not on the background)
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("wahwah.mp3"));
